...
function ShoppingDayForHomePageCarousel() {
    ...
    function hompagecarusel(){
        let url = API+'api/ShoppingDayForHomePageCarouselJson/';
        axios.post(url,{"data":addcarousel}).then(res => {
            console.log(res.data);
    ...
    return (
        <div className="ShoppingDayForHomePageCarousel">
            ...
            <h1 className="title mt-3 text-center">Add ShoppingDayForHomePageCarousel</h1>
                ...
                <div className="row">
                    ...
                    <div className="col">
                        <img style={{height:"135px"}} src={ImgShow} alt=""/>
                    </div>
