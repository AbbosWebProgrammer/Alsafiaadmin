...
function ShoppingDayForBrandCarousel(props) {
    ...
    return (
        <div className="ShoppingDayForBrandCarousel">
            <div className="container">
                <div className="row">
                    <div className="col">
                        ...
                        <select name="category" id="category" className="form-select" multiple={true}>
                            {category.map(item=>{
...
export default ShoppingDayForBrandCarousel;