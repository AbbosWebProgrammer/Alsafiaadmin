...
function MainPagePromoSlider() {
    ...
    function hompagecarusel(){
        axios.post(API+'api/MainPagePromoForHomePageSliderJson/',{"data":addcarousel}).then(res => {
            console.log(res.data);
    ...
    return (
            ...
            <h1 className="title mt-3 text-center">Add MainPagePromoForHomePageSlider</h1>
...
export default MainPagePromoSlider;
